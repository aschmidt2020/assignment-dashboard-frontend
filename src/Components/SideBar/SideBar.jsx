    ...
    return (
        <div>
            <nav className="d-flex flex-column flex-shrink-0 p-3">
                {userInfo && <h5 className="navbar-welcome-text" style={{ 'marginBottom': '0.5em' }}>Welcome {userInfo.first_name}!</h5>}
                {userInfo && !userInfo.is_staff && <p className="navbar-welcome-text"><mark>Student Dashboard</mark></p>}
                {userInfo && userInfo.is_staff && <p className="navbar-welcome-text"><mark>Educator Dashboard</mark></p>}
                {!userInfo && <span className="navbar-welcome-text">Please log-in.</span>}
                <br></br>
